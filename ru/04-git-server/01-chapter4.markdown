...
Теперь самое время инициализировать Gitosis. Сделаете это, выполнив команду `gitosis-init` со своим персональным публичным ключом. Если вашего публичного ключа ещё нет на сервере, вам нужно будете скопировать его туда:
...
Если есть возможность, сейчас также самое время добавить ваш публичный SSH-ключ. Мы рассмотрели, как создать ключ, ранее, в разделе "Создание публичного SSH-ключа". Возьмите содержимое публичного ключа из этой пары и вставьте в поле ввода публичного SSH-ключа. Ссылка "Нужна помощь с публичными ключами?" направит вас к детальным инструкциям, как это сделать на всех основных операционных системах.
